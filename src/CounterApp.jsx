...
const CounterApp = () => {
  const[amount,setAmount]=useState(0)//use state hook return array
  console.log(amount);
...
<input onChange={e=>setAmount(e.target.value)} placeholder='Enter the amount to be incremented' style={{height:'50px',width:'180%',marginTop:'20px',fontSize:'1.7rem'}}  className='form-control text-center mb-3 ' type="number" />
